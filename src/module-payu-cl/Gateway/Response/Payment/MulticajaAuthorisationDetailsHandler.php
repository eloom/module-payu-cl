...
namespace Eloom\PayUCl\Gateway\Response\Payment;
...
class MulticajaAuthorisationDetailsHandler implements HandlerInterface {
	...
	public function handle(array $handlingSubject, array $response) {
		...
		$payment->setAdditionalInformation('paymentLink', $transaction->extraParameters->BANK_URL);
